...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/destiner/code/contract-scan/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/destiner/code/contract-scan/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/destiner/code/contract-scan/node_modules/devalue/index.js';
import destr from 'file:///Users/destiner/code/contract-scan/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/destiner/code/contract-scan/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/destiner/code/contract-scan/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/destiner/code/contract-scan/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/destiner/code/contract-scan/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/destiner/code/contract-scan/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/destiner/code/contract-scan/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/destiner/code/contract-scan/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/destiner/code/contract-scan/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/destiner/code/contract-scan/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/destiner/code/contract-scan/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/destiner/code/contract-scan/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/destiner/code/contract-scan/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/destiner/code/contract-scan/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/destiner/code/contract-scan/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/destiner/code/contract-scan/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/destiner/code/contract-scan/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/destiner/code/contract-scan/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/destiner/code/contract-scan/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/destiner/code/contract-scan/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/destiner/code/contract-scan","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/destiner/code/contract-scan/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/destiner/code/contract-scan/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/destiner/code/contract-scan/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/destiner/code/contract-scan/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ql3UO031zG = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/destiner/code/contract-scan";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _F1wYDwLzAX = (nitroApp) => {
...
const _lazy_nYDKLB = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_nYDKLB, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nYDKLB, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"title","content":"ContractScan"},{"name":"description","content":"Search deployed contracts across 100+ EVM chains"},{"property":"og:image","content":"https://contractscan.xyz/api/og"},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://contractscan.xyz"},{"property":"og:title","content":"ContractScan"},{"property":"og:description","content":"Search deployed contracts across 100+ EVM chains"},{"property":"twitter:image","content":"https://contractscan.xyz/api/og"},{"property":"twitter:card","content":"summary_large_image"},{"property":"twitter:url","content":"https://contractscan.xyz"},{"property":"twitter:title","content":"ContractScan"},{"property":"twitter:description","content":"Search deployed contracts across 100+ EVM chains"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"},{"rel":"mask-icon","href":"/mask-icon.svg","color":"#000000"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png","sizes":"180x180"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"ContractScan"};
...
const getClientManifest = () => import('file:///Users/destiner/code/contract-scan/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/destiner/code/contract-scan/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
